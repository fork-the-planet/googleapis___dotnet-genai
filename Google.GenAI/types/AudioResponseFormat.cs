...
namespace Google.GenAI.Types {
  ...
  public record AudioResponseFormat {
    ...
    /// <returns>The deserialized AudioResponseFormat object, or null if deserialization
    /// fails.</returns>
    public static AudioResponseFormat
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<AudioResponseFormat>(jsonString, options);
