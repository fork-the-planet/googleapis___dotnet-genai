...
namespace Google.GenAI.Types {
  ...
  public record ResponseFormat {
    ...
    public AudioResponseFormat ? Audio { get; set; }
    ...
    /// <returns>The deserialized ResponseFormat object, or null if deserialization fails.</returns>
    public static ResponseFormat
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize(jsonString, JsonConfig.TypeInfo<ResponseFormat>(options));
